...
public class OR_RateGrid{
	...
	public static final String ratePlanNamesExpanCollapseIcon="//span[contains(@class,'pr-5')]";
	...
	public static final String rateGridPopupRateChangeHeader="//span[@class='changes-header']";
	...
	public static final String defaultRatePlan="//div[@class='Select-value']/span";
	public static final String bestAvailableRoomClass="//div[@class='small']";
	public static final String bestAvailableRateLabel="//div[contains(text(),'Best Available Rates')]";
	public static final String regularRates="//div[contains(@class,'RegularRate')]";
