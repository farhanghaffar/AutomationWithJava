...
public class TaxExemptInDepositAmountInRes extends TestCore {
	...
	public void taxExemptInDepositAmountInRes(String url, String clientCode, String userName, String password,
			...
			String policyType, String chargestype, String number, String policyText, String policyDesc, String season) {
		...
		try {
			...
			res.get_TripSummaryTripTotalChargesWithCurrency(driver, test_steps);
	...
	public Object[][] getData() {
		return Utility.getData("TaxExemptInDepositAmountInRes", excel);
