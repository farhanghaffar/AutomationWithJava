...
public class Verify_Notes_Tasks_CP_Reservation extends TestCore{
	...
	public void Verify_Notes_Tasks_CP_Reservation(String url, String ClientCode, String Username, String Password,String PropertyName,String CheckInDate,String CheckOutDate,String Adults,String Children,String Rateplan,String PromoCode,
		...
		test_name = "Verify_Notes_Tasks_CP_Reservation";
		test_description = "CP Reservation Creation<br>"
				+ "<a href='https://innroad.testrail.io/index.php?/cases/view/667708' target='_blank'>"
				+ "Click here to open TestRail: 667708</a>";
		...
		try {
			...
			res.enter_NotesWithTimeZone(driver, test_steps, IsAddNotes, NoteType, Subject,Description,timeZone);
			if(falg) {
	...
	public Object[][] getData() {
		...
		return Utility.getData("Verify_Note_Task_CP_Reservation", excel);
	}
