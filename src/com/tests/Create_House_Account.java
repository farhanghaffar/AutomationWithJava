...
public class Create_House_Account extends TestCore{
	...
	public void Create_House_Account(String url, String ClientCode, String Username, String Password,String PropertyName,String CheckInDate,String CheckOutDate,String Adults,String Children,String Rateplan,String PromoCode,String IsSplitRes,
		...
		test_name = "Create House Account and verify Payments";
		...
		test_catagory = "Create House Account and verify Payments";
		...
		try {
			...
			res.select_HouseAccoutAsPayment(driver, test_steps, AccountName);
			...
			res.verify_AccountFolio(driver, test_steps, AccountName);
			String amount=res.pay_Account(driver, test_steps, AccountName, IsChangeInPayAmount, ChangedAmountValue, TakePaymentType);
			res.verify_AccountPaymentLineItemHA(driver, test_steps, amount, AccountName);
			
			res.click_History(driver, test_steps);
			res.verify_AcountPaymentInHistory(driver, test_steps, Double.parseDouble(amount), AccountName,RoomAbbri,Rooms,timeZone);
	...
	public Object[][] getData() {
		...
		return Utility.getData("Create_House_Account", excel);
	}
