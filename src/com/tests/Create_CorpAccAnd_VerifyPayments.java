...
public class Create_CorpAccAnd_VerifyPayments extends TestCore{
	...
	public void create_CorpAccAnd_VerifyPayments(String url, String ClientCode, String Username, String Password,String PropertyName,String CheckInDate,String CheckOutDate,String Adults,String Children,String Rateplan,String PromoCode,String IsSplitRes,
		...
		test_name = "Create_CorpAccAnd_VerifyPayments";
		...
		test_catagory = "Create_CorpAccAnd_VerifyPayments";
		...
		try {
			...
			res.verifyAddedLineItem(driver, test_steps, LineItemCategory, LineItemCategoryAmount);
			 bal=res.get_FilioBalance(driver);
			test_steps.add("Reservation folio balance : "+ bal);
			app_logs.info("Reservation folio balance : "+ bal);
			String amount=res.pay_Account(driver, test_steps, Account, IsChangeInPayAmount, ChangedAmountValue, TakePaymentType);
			res.verify_AccountPaymentLineItem(driver, test_steps, amount, Account);
			res.click_History(driver, test_steps);
			res.verify_AcountPaymentInHistory(driver, test_steps, Double.parseDouble(amount), Account,RoomAbbri,Rooms,timeZone);
	...
	public Object[][] getData() {
		...
		return Utility.getData("Create_CorpAccAnd_VerifyPayment", excel);
	}
