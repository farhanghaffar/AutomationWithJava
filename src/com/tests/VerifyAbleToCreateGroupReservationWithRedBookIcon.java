...
public class VerifyAbleToCreateGroupReservationWithRedBookIcon extends TestCore {
	...
	public void verifyAbleToCreateGroupReservationWithRedBookIcon(String rateName, String baseAmount,
		...
		String testName = "VerifyAbleToCreateGroupReservationWithRedBookIcon";
		test_description = "Desktop : Advanced group : Verify able to create group reservation with Red Book icon.<br>"
				+ "<a href='https://innroad.testrail.io/index.php?/cases/view/682423' target='_blank'>"
				+ "Click here to open TestRail: C682423</a>";
	...
	public Object[][] getData() {
		...
		return Utility.getData("CreateResFromRedIcon", excel);
	}
