...
public class Create_CP_Quote_MRB_Reservation extends TestCore{
	...
	public void Create_CP_Quote_MRB_Reservation(String url, String ClientCode, String Username, String Password,String PropertyName,String CheckInDate,String CheckOutDate,String Adults,String Children,String Rateplan,String PromoCode,String IsSplitRes,
		...
		test_description = "CP MRB Quote Reservation Creation"
				+ "<a href='https://innroad.testrail.io/index.php?/cases/view/682454' target='_blank'>"
				+ "Click here to open TestRail: C682454</a>";
		...
		try {
			...
			CheckInDate = checkInDates.get(0) + "|" + checkInDates.get(1) + "|" + checkInDates.get(2);
			CheckOutDate = checkOutDates.get(0) + "|" + checkOutDates.get(1) + "|" + checkOutDates.get(2);
	...
	public Object[][] getData() {
		...
		return Utility.getData("Create_CP_Quote_MRB_Reservation", excel);
	}
