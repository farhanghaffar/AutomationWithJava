...
public class VerifyAvailabilityInBulkUpdate extends TestCore {
	...
	public void verifyAvailabilityInBulkUpdate(String checkInDate, String checkOutDate, String isSundayCheck, String isMondayCheck,
			String isTuesdayChecked, String isWednesdayChecked, String isThursdayChecked, String isFridayChecked, String isSaturdayChecked,
			String isTotalOccupancyOn, String totalOccupancyType, String totalOccupancyValue, String roomClassName, 
			String channel, String updateAvailability, String availability) throws Exception {
		...
		try {
			...
			getTestSteps.clear();
			getTestSteps = overView.selectBulkUpdateOption(driver, availability);
			testSteps.addAll(getTestSteps);
		...
		try {
			...
			getTestSteps.clear();
			getTestSteps = overView.checkDays(driver, "Tue", isTuesdayChecked);
			testSteps.addAll(getTestSteps);

			getTestSteps.clear();
			getTestSteps = overView.checkDays(driver, "Wed", isWednesdayChecked);
			testSteps.addAll(getTestSteps);

			getTestSteps.clear();
			getTestSteps = overView.checkDays(driver, "Thu", isThursdayChecked);
			testSteps.addAll(getTestSteps);

			getTestSteps.clear();
			getTestSteps = overView.checkDays(driver, "Fri", isFridayChecked);
			testSteps.addAll(getTestSteps);

			getTestSteps.clear();
			getTestSteps = overView.checkDays(driver, "Sat", isSaturdayChecked);
			testSteps.addAll(getTestSteps);
		...
		try{
			...
			for(String channelString : channelArr){
				app_logs.info(channelString.trim());
			getTestSteps.clear();
			getTestSteps = overView.selectUpdateAvailability(driver, channelString.trim(), updateAvailability);
			testSteps.addAll(getTestSteps);
			}
		...
		try{
			...
			String totalDays = overView.getTotalDaysText(driver, availability);
	...
	public Object[][] getData() {
		...
		return Utility.getData("VerifyAvailabilityInBulkUpdate", excel);
	}
