...
public class Create_CP_MRB_SplitReservation extends TestCore{
	...
	public void Create_CP_MRB_SplitReservation(String url, String ClientCode, String Username, String Password,String CheckInDate,String CheckOutDate,String Adults,String Children,String Rateplan,String PromoCode,String IsSplitRes,
		...
		test_name = "Create_CP_MRB_SplitReservation";
		test_description = "CP MRB Reservation Creation <br>"
				+ "<a href='https://innroad.testrail.io/index.php?/cases/view/681783' target='_blank'>"
				+ "Click here to open TestRail: C681783</a>";
		test_catagory = "CP_Split_MRB_Reservation";
	...
	public Object[][] getData() {
		...
		return Utility.getData("Create_CP_MRB_SplitReservation", excel);
	}
