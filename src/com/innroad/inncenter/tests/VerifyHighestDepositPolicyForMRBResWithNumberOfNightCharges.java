...
public class VerifyHighestDepositPolicyForMRBResWithNumberOfNightCharges extends TestCore{
	...
	public void verifyHighestDepositPolicyForMRBResWithNumberOfNightCharges(String roomClassName, String roomClassAbb, String maxAdults, 
		...
		String testDescription = "Verify Deposit policy calculation for MRB when each room has different no.of "
				+ "Night room charges as Policy attribute<br>"
