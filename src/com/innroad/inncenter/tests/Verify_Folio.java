...
public class Verify_Folio extends TestCore{
	...
	public void Verify_Folio(String url, String ClientCode, String Username, String Password,String CheckInDate,String CheckOutDate,String Adults,String Children,String Rateplan,String PromoCode,
		...
		test_name = "Verify Filio";
		test_description = "Verify Filio<br>"
				+ "<a href='https://innroad.testrail.io/index.php?/cases/view/681667' target='_blank'>"
				+ "Click here to open TestRail: C681667</a>";
		test_catagory = "Verify Filio";
	...
	public Object[][] getData() {
		...
		return Utility.getData("Verify_Folio", excel);
	}
